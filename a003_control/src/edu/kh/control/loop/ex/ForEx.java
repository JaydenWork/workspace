...
public class ForEx {
	...
	public void ex6() {
		...
		for(double i = 10; i <= 20; i += 0.5) {
			...
			//왜? i += 0.5 수행 시 10.5가 아닌 10(int형으로) 형변환되어 i에 대입되기 때문에
			// i 가 계속 10을 유지한다
			
			//해결 방법 : 초기식을 double 자료형으로 변경해주면 된다.
