...
public class StudentService {
	 ...
	 * @param name      : String
	 * 
	 * @return result : boolean(학생 추가 성공 시 true 반환하도록)
	 **/
	...
	public Student selectIndex(int index) {
		...
		// 배열 범위를 초과 했다는 ArrayIndexOutOfBoundsException발생
	 ...
	 * 
	 * @return resultArr : Student[](조회된 학생이 없을 경우 null로 반환)
	 */
	...
	public boolean updateStudent(int index, int kor, int eng, int math) {
		...
		studentArr[index].setKor(eng);
		studentArr[index].setKor(math);
		return true;
