...
COMMENT ON COLUMN "MEMBER"."MEMBER_TEL" IS '전화번호(-없이)';
...
-- 샘플 계정 추가
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user2', '$2a$10$xbpptBq4CVB/tJqvoM573.wpsrDGcO6dwszDfBH1kjmRlRdWOxD9O'
, '유저이', '01063560903', '04540,,서울시 중구 남대문로 120,,2층',
NULL, DEFAULT, DEFAULT, DEFAULT);


INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user01@kh.or.kr', 'pass01'
, '삼번유저', '01023456789', '04540,,서울시 중구 남대문로 120,,2층',
NULL, DEFAULT, DEFAULT, DEFAULT);

INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, '1', '1'
, '삼번유저', '11122223333', '11111,,123123123',
NULL, DEFAULT, DEFAULT, DEFAULT);
...
-- 아이디 '1'유저의 비밀번호 변경
UPDATE "MEMBER" SET 
MEMBER_PW = '$2a$10$ou9BUAMqRrWq5sR8TTbuBugvdjCzBiFaWg6n5.5d0gbgnPL2lFvvG';
...
WHERE MEMBER_EMAIL = '유저일'
AND MEMBER_DEL_FL = 'N';


-- 이메일로 회원 정보 조회
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, NVL(MEMBER_ADDR,'미작성') MEMBER_TEL, MEMBER_ADDR, 
TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') AS ENROLL_DATE
FROM "MEMBER"
...
COMMENT ON COLUMN "BOARD_TYPE"."BOARD_NAME" IS '게시판 이름(SEQ_BOARD_CODE)';
...
ALTER SEQUENCE COMMENT_NO INCREMENT BY {새로운_값 - 현재_값};
SELECT COMMENT_NO.NEXTVAL FROM DUAL;
ALTER SEQUENCE COMMENT_NO INCREMENT BY 1;

ALTER SEQUENCE SEQ_COMMENT_NO START WITH 1;
...
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00001.jpg', 'cat1.jpg', 0, 4502);
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00002.jpg', 'cat2.jpg', 0, 4500);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/images/board/',
		'20230508115013_00003.jpg', 'cat5.jpg', 1, 1502);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00004.jpg', 'cat4.jpg', 0, 4494);
	
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00005.jpg', 'cat5.jpg', 0, 4490);
...
-- 게시글 좋아요 샘플데이터 삽입
INSERT INTO "BOARD_LIKE" VALUES(4504, 19);
INSERT INTO "BOARD_LIKE" VALUES(4502, 19);
INSERT INTO "BOARD_LIKE" VALUES(4501, 19);
...
SELECT COMMENT_NO, COMMENT_CONTENT,
 ...
 --회원 프로필 이미지 변경
 UPDATE "MEMBER" SET
 PROFILE_IMG = '/images/member/profile3.jpeg'
 WHERE MEMBER_NO = 1;

 UPDATE "MEMBER" SET
 PROFILE_IMG = '/resources/images/member/profile1.jpeg'
 WHERE MEMBER_NO = 19;
...
---좋아요 테이블 삽입
INSERT INTO BOARD_LIKE VALUES(1499,19);

DELETE FROM BOARD_LIKE WHERE BOARD_NO = 1500 AND MEMBER_NO = 1;
...
FROM (
   SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
           0 IMG_ORDER, 4505 BOARD_NO
   FROM DUAL   
   UNION ALL
   SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
           1 IMG_ORDER, 4505 BOARD_NO
   FROM DUAL
   UNION ALL
   SELECT '웹접근경로' IMG_PATH, '변경명' IMG_RENAME, '원본명' IMG_ORIGINAL,
           2 IMG_ORDER, 4505 BOARD_NO
   FROM DUAL
) A;
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 3333', DEFAULT, DEFAULT, 1502, 1, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 1502, 1, NULL);
...
UPDATE PROFILE_IMG SET IMG_PATH='/images/board/';
COMMIT;
