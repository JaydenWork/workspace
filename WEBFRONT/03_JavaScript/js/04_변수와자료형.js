// 전역 변수
var str = 'js 코드를 함수 내부가 아닌 js파일 또는 script태그에 바로 작성하면';
+'html 랜더링 시 바로 수행된다.';
...
function testFn() {
  ...
  console.log('함수 내부에서 선언된 (함)num4 : ' + num4);
...
console.log('함수 밖에서 (함)num4 : ' + num4);
...
function typeTest() {
  ...
  box.innerHTML += '<br>user.adress : ' + user.address;
  ...
  // 함수명만 작성 : 함수에 작성된 코드가 그래도 출력
  // 함수명() 작성 : 함수 실행(함수호출)

  box.innerHTML += '<br>sumFn : ' + sumFn(1, 2);
