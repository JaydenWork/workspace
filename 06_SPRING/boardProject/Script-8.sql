...
BEGIN
   FOR I IN 1..1500 LOOP
      ...
      VALUES( SEQ_BOARD_NO.NEXTVAL,
              ...
              DEFAULT, DEFAULT, DEFAULT, DEFAULT, 19, 
...
INSERT INTO BOARD_IMG
VALUES(SEQ_IMG_NO.NEXTVAL, '/resources/images/board/',
		'20230508115013_00003.jpg', 'cat3.jpg', 0, 4496);
...
SELECT COMMENT_NO, COMMENT_CONTENT,
 ...
 --회원 프로필 이미지 변경
 UPDATE "MEMBER" SET
 PROFILE_IMG = '/resources/images/member/profile3.jpeg'
 WHERE MEMBER_NO = 2;
...
DELETE FROM BOARD_LIKE WHERE BOARD_NO = 4502 AND MEMBER_NO = 19;
...
INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 3333', DEFAULT, DEFAULT, 4510, 19, NULL);

INSERT INTO "COMMENT"
VALUES(SEQ_COMMENT_NO.NEXTVAL, '부모 댓글 2', DEFAULT, DEFAULT, 4510, 19, NULL);
