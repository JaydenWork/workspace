...
public class TestWebsocketHandler extends TextWebSocketHandler{
	...
	// -> 멀티쓰레드(줄 안서고 기능들이 서로 실행되려고 함) 환경에서 쓰레드간의 의도치 않은 충돌을 예방하기 위해서 동기화(줄세워서 처리함)
	...
	public void afterConnectionEstablished(WebSocketSession session) throws Exception {
		// 클라이언트 웹소켓 연결을 요청하면 sessions에 클라이언트와의 전이중 통신을 담당하는 객체(WebSocketSession을 추가한다)
