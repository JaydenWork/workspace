...
if (updateInfo != null) {
  // updateInfo 태그가 있는 페이지에서만 유효성 검사를 하게 하는거임
...
if (imageInput != null) {
  ...
  imageInput.addEventListener('change', (e) => {
    // 2MB로 최대 크기 제한
    const maxSize = 1024 * 1024 * 2; // 파일 최대 크기 지정(바이트 단위)
    ...
    if (file.size > maxSize) {
      ...
      imageInput.value = '';
      // input type="file" 태그에 대입할 수 있는 value는 "" (빈 칸) 뿐이다!
